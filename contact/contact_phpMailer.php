<?php
echo "2222222";
require_once("contact/class.phpmailer.php");
echo "888888888";
if(!$_POST) exit;
echo "33333333";
...
$e_subject = ' Select Model Railroads - You\'ve been Contacted by ' . $name . '.';
...
$mail->Body = $msg;
$mail->AddAddress('fariche25@gmail.com', 'Joredan');
echo "rrrrrrrrrrrr";
 if($mail->Send()) {
     echo"dddddddd $mail->Body";
 }
